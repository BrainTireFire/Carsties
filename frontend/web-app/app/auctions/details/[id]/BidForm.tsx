  ...
  return (
    ...
    >
      <input
        type="number"
        {...register("amount")}
        className="flex-grow pl-5 bg-transparent focus:outline-none border-transparent first-letter:focus:border-transparent focus:ring-0 text-sm text-gray-600"
